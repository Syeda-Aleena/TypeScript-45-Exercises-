...
console.log(
  "Unfortunately, the new dinner table wont arrive on time, so i can only invite two guests to dinner with"
);
...
while (guestList.length > 2) {
  ...
  console.log(`Sorry, ${removeGuest} i can't invite you for the dinner`);
}
...
guestList.forEach((lastTwo) =>
  console.log(`Luckily ${lastTwo}, you are still invited to the dinner`)
);
